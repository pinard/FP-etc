...
def register_key_bindings(normal_leader, insert_leader):
    for key, modes, name in (
            ('j',     'n',  'next_visible_topic'),
            ('J',     'n',  'last_visible_topic'),
            ('k',     'n',  'previous_visible_topic'),
            ('K',     'n',  'first_visible_topic'),
            ('l',     'n',  'next_sibling'),
            ('L',     'n',  'last_sibling'),
            ('h',     'n',  'previous_sibling'),
            ('H',     'n',  'first_sibling'),
            ('u',     'n',  'up_level'),
            ('1',     'n',  'down_to_1st_child'),
            ('2',     'n',  'down_to_2nd_child'),
            ('3',     'n',  'down_to_3rd_child'),
            ('4',     'n',  'down_to_4th_child'),
            ('5',     'n',  'down_to_5th_child'),
            ('6',     'n',  'down_to_6th_child'),
            ('7',     'n',  'down_to_7th_child'),
            ('8',     'n',  'down_to_8th_child'),
            ('9',     'n',  'down_to_9th_child'),
            ('^',     'n',  'beginning_of_text'),
            ('$',     'n',  'end_of_text'),
            ('v',     'n',  'visual_text'),
            ('V',     'n',  'visual_level'),
            ...
            ('d',     'n',  'delete_text'),
            ('D',     'n',  'delete_level'),
            ('<CR>',  'nv', 'rebullet_topic'),
            ('#',     'nv', 'number_siblings'),
            ('~',     'nv', 'revoke_numbering'),
            ('<Bar>', 'nv', 'adjust_margin'),
            ('0',     'nv', 'remove_margin'),
            ('>',     'nv', 'shift_in'),
            ('<',     'nv', 'shift_out'),
            ('_',     'n',  'space_topic'),
...
# hypothetical 0-level topic is sometimes assumed.  When an necessary
